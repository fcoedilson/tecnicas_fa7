package br.com.cardetails.util;
...
public class DateUtil {
	...
	public static final String DEFAULT_HOUR_PATTERN_2 = "HH:mm";
	...
	public static final String US_DATE_PATTERN_GENERAL_2 = "yyyy-MM-dd HH:mm:ss";
	...
	public static String parseDateUsAsString(Date value){

		return parseAsString(US_DATE_PATTERN_GENERAL_2, value);
	}
	...
	public static String parseTimeHourAsString(Date value){

		return parseAsString(DEFAULT_HOUR_PATTERN_2, value);
	}
	...
	public static Date parseStringAsDateNormal(String value) {

		return parseStringAsDate(US_DATE_PATTERN_GENERAL_2, value);
	}
